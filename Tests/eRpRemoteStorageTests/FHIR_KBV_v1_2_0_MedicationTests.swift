...
final class FHIR_KBV_v1_2_0_MedicationTests: XCTestCase {
    ...
    func testParsingMedication_Ingredient() throws {
        ...
        expect(medication.dosageForm) == "Tabletten"
        expect(medication.amountRatio(for: .v1_2_0)) == ErxMedication.Ratio(
        ...
        expect(medication.erxTaskIngredients[0]) == ErxMedication.Ingredient(
            ...
            strength: ErxMedication.Ratio(
                numerator: ErxMedication.Quantity(value: "5", unit: "mg"),
                denominator: ErxMedication.Quantity(value: "1")
            ),
        ...
        expect(medication.erxTaskIngredients[2]) == ErxMedication.Ingredient(
            text: "Hydrochlorothiazid",
            number: "00512",
            form: nil,
            strength: ErxMedication.Ratio(
                numerator: ErxMedication.Quantity(value: "12.5", unit: "mg"),
                denominator: ErxMedication.Quantity(value: "1")
            ),
            strengthFreeText: nil
        )
    ...
    func testParsingMedication_Compounding() throws {
        ...
        expect(medication.drugCategory) == .avm
        expect(medication.isVaccine).to(beFalse())
        expect(medication.compoundingInstruction) == "M.D.S."
        ...
        expect(medication.dosageForm) == "Gel"
        ...
        expect(medication.erxTaskIngredients[0]) == ErxMedication.Ingredient(
            ...
            form: nil,
            strength: ErxMedication.Ratio(
                numerator: ErxMedication.Quantity(value: "20", unit: "g"),
                denominator: ErxMedication.Quantity(value: "1")
            ),
            strengthFreeText: nil
        )
        expect(medication.erxTaskIngredients[1]) == ErxMedication.Ingredient(
            ...
            form: "Pulver",
            strength: ErxMedication.Ratio(
                numerator: ErxMedication.Quantity(value: "2", unit: "g"),
                denominator: ErxMedication.Quantity(value: "1")
            ),
            strengthFreeText: nil
        )
    ...
    private func decode(
        ...
        from bundle: FHIRBundleDirectories = .kbv_v1_2_0
