...
/// - workflow bundle version: 1.5.2
final class FHIR_GEM_Workflow_v1_5_2_CommunicationTests: XCTestCase {
    func testListAllCommunicationsWithSuccess() throws {
        ...
        expect(sut.count) == 5
        expect(sut[0]) == ErxTask.Fixtures.communicationDiGA
        expect(sut[1]) == ErxTask.Fixtures.communicationDispReq
        expect(sut[2]) == ErxTask.Fixtures.communicationReply1
        expect(sut[3]) == ErxTask.Fixtures.communicationReply2
        expect(sut[4]) == ErxTask.Fixtures.communicationReply3
    }
...
private extension ErxTask {
    enum Fixtures {
        static let communicationDiGA = ErxTask.Communication(
            identifier: "140f716f-f649-44fe-9a4e-157eb3c8adf3",
            profile: eRpKit.ErxTask.Communication.Profile.diga,
            taskId: "162.000.000.000.000.01",
            userId: "X234567890",
            telematikId: "3-02.3.4111108800.16.806",
            orderId: nil,
            timestamp: "2025-10-01T15:29:00.434+00:00",
            payloadJSON: "Nachrichteninhalt für den Versicherten",
            isRead: false
        )
