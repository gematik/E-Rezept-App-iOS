...
class JWETests: XCTestCase {
    ...
    func testHeaderEncoding() throws {
        ...
        let encodedHeaderBase64 = try XCTUnwrap(encodedHeader.base64EncodedData().utf8string)
    ...
    func testPremadeJWE() throws {
        ...
        let completeJWE = try XCTUnwrap(sut.encoded().utf8string)
