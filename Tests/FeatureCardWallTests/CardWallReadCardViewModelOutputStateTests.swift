...
final class CardWallReadCardViewModelOutputStateTests: XCTestCase {
    ...
    let titleNext: StringAsset = L10n.cdwBtnRcNext
    let titleRetry: StringAsset = L10n.cdwBtnRcRetry
    let titleClose: StringAsset = L10n.cdwBtnRcClose
    let titleLoading: StringAsset = L10n.cdwBtnRcLoading
    let titleBackToCan: StringAsset = L10n.cdwBtnRcCorrectCan
    let titleBackToPin: StringAsset = L10n.cdwBtnRcCorrectPin
