...
extension IntegrationTestsConfiguration {
    enum Environment {
        ...
        static let IDP_SEK_URL_SERVER_GMTKDEV_URL = AppConfiguration.Environment.IDP_SEK_URL_SERVER_GMTKDEV_URL
        static let IDP_SEK_URL_SERVER_GMTKDEV_X_AUTH = AppConfiguration.Environment.IDP_SEK_URL_SERVER_GMTKDEV_X_AUTH
        ...
        static let AVS_TEST_INT_GMTKDEV_URL = AppConfiguration.Environment.AVS_TEST_INT_GMTKDEV_URL
        static let AVS_TEST_INT_GMTKDEV_X_AUTH = AppConfiguration.Environment.AVS_TEST_INT_GMTKDEV_X_AUTH
    }
}
