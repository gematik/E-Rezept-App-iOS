...
struct DiGaDetailsScreen<Previous: Screen>: Screen {
    ...
    func tapRefreshButton(fileID: String = #fileID, file: String = #filePath, line: UInt = #line) {
        button(by: A11y.diga.detail.digaDtlBtnRefresh, fileID: fileID, file: file, line: line).tap()
    }
...
//        button(within: app.navigationBars, by: "Rezepte", fileID: fileID, file: file, line: line).tap()
    ...
    func tapMenu(fileID: String = #fileID, file: String = #filePath, line: UInt = #line) -> Menu {
        button(by: A11y.diga.detail.digaDtlBtnToolbarItem, fileID: fileID, file: file, line: line).buttons.firstMatch
    ...
    func tapDescriptionButton(_ screen: (DiGaDescriptionScreen) async -> Void,
                              fileID: String = #fileID,
                              file: String = #filePath,
                              line: UInt = #line) async {
        button(by: A11y.diga.detail.digaDtlBtnDescription, fileID: fileID, file: file, line: line).tap()

        let digaDescriptionScreen = DiGaDescriptionScreen(app: app)
        await screen(digaDescriptionScreen)
    }

    func tapSupportButton(_ screen: (DiGaSupportScreen) async -> Void,
                          fileID: String = #fileID,
                          file: String = #filePath,
                          line: UInt = #line) async {
        button(by: A11y.diga.detail.digaDtlBtnSupport, fileID: fileID, file: file, line: line).tap()

        let digaSupportScreen = DiGaSupportScreen(app: app)
        await screen(digaSupportScreen)
    }
    ...
    func tapSelectInsurance(
        ...
        button(by: A11y.diga.detail.digaDtlBtnMainSelectInsurance, fileID: fileID, file: file, line: line).tap()
    ...
    func tapSelectedInsurance(
        ...
        button(by: A11y.diga.detail.digaDtlBtnMainSelectedInsurance, fileID: fileID, file: file, line: line).tap()

        let diGaInsuranceListScreen = DiGaInsuranceListScreen(app: app)
        await screen(diGaInsuranceListScreen)
    }

    func bfarmErrorHint(fileID: String = #fileID, file: String = #filePath, line: UInt = #line) -> XCUIElement {
        staticText(by: A11y.diga.detail.digaDtlTxtHintNoConnection, fileID: fileID, file: file, line: line)
    }

    func noIosHint(fileID: String = #fileID, file: String = #filePath, line: UInt = #line) -> XCUIElement {
        staticText(by: A11y.diga.detail.digaDtlTxtHintNoIos, fileID: fileID, file: file, line: line)
    }

    func tapSelectSegmented(
        segment: DiGaDetailSegments,
        fileID _: String = #fileID,
        file _: String = #filePath,
        line _: UInt = #line
    ) {
        app.segmentedControls.buttons[segment.displayText].tap()
    }
    ...
    func digaDetailStaticText(identifier: String,
                              label: String,
                              fileID _: String = #fileID,
                              file _: String = #filePath,
                              line _: UInt = #line) -> Bool {
        let elements = app.staticTexts.matching(identifier: identifier).allElementsBoundByIndex
        return elements.contains { $0.label == label }
    }
    ...
    struct Menu: Screen {
        ...
        func tapDelete(fileID: String = #fileID, file: String = #filePath, line: UInt = #line) {
            button(by: A11y.diga.detail.digaDtlBtnDeleteToolbar, fileID: fileID, file: file, line: line).tap()
        }
    }
