...
public class AVSSessionMock: AVSSession {
    ...
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseThrowableError: (any Error)?
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseCallsCount = 0
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseCalled: Bool {
        return redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseCallsCount > 0
    }
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReceivedArguments: (message: AVSMessage, endpoint: AVSEndpoint, recipients: [X509])?
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReceivedInvocations: [(message: AVSMessage, endpoint: AVSEndpoint, recipients: [X509])] = []
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReturnValue: AVSSessionResponse!
    public var redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseClosure: ((AVSMessage, AVSEndpoint, [X509]) async throws -> AVSSessionResponse)?

    public func redeem(message: AVSMessage, endpoint: AVSEndpoint, recipients: [X509]) async throws -> AVSSessionResponse {
        redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseCallsCount += 1
        redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReceivedArguments = (message: message, endpoint: endpoint, recipients: recipients)
        redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReceivedInvocations.append((message: message, endpoint: endpoint, recipients: recipients))
        if let error = redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseThrowableError {
            throw error
        }
        if let redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseClosure = redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseClosure {
            return try await redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseClosure(message, endpoint, recipients)
        } else {
            return redeemMessageAVSMessageEndpointAVSEndpointRecipientsX509AVSSessionResponseReturnValue
        }
    }
