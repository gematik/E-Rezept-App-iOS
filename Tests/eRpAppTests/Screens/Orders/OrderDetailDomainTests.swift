...
//    ) -> TestStore {
//        TestStore(
//            initialState: OrdersDomain.State(communications: []),
...
//    ) -> TestStore {
//        TestStore(
//            initialState: OrdersDomain.State(communications: communications),
//            reducer: OrdersDomain.domainReducer,
//            environment: OrdersDomain.Environment(
//                schedulers: schedulers,
...
//            state.route = .alert(OrdersDomain.openUrlAlertState(for: expectedUrl))
//        }
//        expect(self.mockApplication.canOpenURLCallsCount) == 1
...
//        let deviceInfo = OrdersDomain.DeviceInformations(
//            model: "TestModel",
...
//        let store = TestStore(
//            initialState: OrdersDomain.State(communications: input),
//            reducer: OrdersDomain.domainReducer,
//            environment: OrdersDomain.Environment(
//                schedulers: schedulers,
//                erxTaskRepository: mockRepository,
