                ...
                if store.diGaInfo.diGaState == .insurance {
                    VStack(alignment: .center, spacing: 4) {
                        Button {
                            ...
                            .accessibilityIdentifier(A11y.diga.detail.digaDtlBtnRefresh)
                           ...
                           let note = dispense.noteText {
                            VStack(alignment: .leading) {
                                Text(note)
                                    ...
                                    .cornerRadius(8)
                                    .accessibilityIdentifier(A11y.diga.detail.digaDtlTxtDeclineNote)
                            }
                            .padding(.leading, 24)
            ...
            var body: some View {
                VStack(alignment: .leading, spacing: 16) {
                    if store.bfarmDiGaDetails?.description != nil {
                        ...
                        .accessibilityIdentifier(A11y.diga.detail.digaDtlBtnDescription)
                    ...
                    if store.diGaDispense?.redeemCode != nil,
                       store.bfArMDisplayInfo?.supportText != nil {
                        ...
                        .accessibilityIdentifier(A11y.diga.detail.digaDtlBtnSupport)
                        .smallSheet(
