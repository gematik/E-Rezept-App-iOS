...
extension SubTitle {
    init(title: StringAsset, description: StringAsset? = nil, details: StringAsset? = nil) {
        self.init(title: title, description: description, details: details, bundle: .module)
    }

    init(title: String, details: StringAsset) {
        self.init(title: title, details: details, bundle: .module)
    }

    init(title: String, description: StringAsset) {
        self.init(title: title, description: description, bundle: .module)
    }
