...
public struct DemoBannerView<Content: View>: View {
    var visible = true
    ...
    public init(
        visible: Bool = true,
        innerContent: Content? = nil,
        turnDemoModeOffCallback: (() -> Void)? = nil
    ) {
        self.visible = visible
        self.innerContent = innerContent
        self.turnDemoModeOffCallback = turnDemoModeOffCallback
    }
...
extension View {
    ...
    public func demoBanner(isPresented: Bool, turnDemoModeOffCallback: (() -> Void)? = nil) -> some View {
        modifier(
