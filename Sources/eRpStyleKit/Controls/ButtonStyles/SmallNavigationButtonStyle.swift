...
extension ButtonStyle where Self == SmallNavigationButtonStyle {
    /// A button style that applies a navigation chevron.
    public static func smallNavigation(back: Bool = false) -> SmallNavigationButtonStyle {
        SmallNavigationButtonStyle(back: back)
    }
}
