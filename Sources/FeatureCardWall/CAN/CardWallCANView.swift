...
public struct CardWallCANView: View {
    @Bindable var store: StoreOf<CardWallCANDomain>

    public init(store: StoreOf<CardWallCANDomain>) {
        self.store = store
    }
    ...
    public var body: some View {
        VStack(spacing: 8) {
            ...
            .buttonStyle(.primary(isEnabled: store.state.can.count == 6, width: .wideHugging))
            .padding(.bottom, 8)
    ...
    struct CANScanButton: View {
        ...
        var body: some View {
            Button {
                ...
                Label(L10n.cdwBtnCanScanner2, systemImage: SFSymbolName.camera)
            }
