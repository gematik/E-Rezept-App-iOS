...
/// Domain for handling health card ordering flow
@Reducer
public struct OrderHealthCardDomain {
    ...
    /// State for the health card order screen
    @ObservableState
    public struct State: Equatable {
        /// Initializes a new state
        public init() {}

        init(searchText: String = "", insuranceCompanies: [HealthInsuranceCompany] = []) {
    ...
    /// Service inquiry types for health card orders
    public enum ServiceInquiry: Int, CaseIterable, Identifiable {
        case pin
...
extension OrderHealthCardDomain {
    public struct HealthInsuranceCompany: Decodable, Identifiable, Hashable {
        public let id = UUID()
        let name: String
