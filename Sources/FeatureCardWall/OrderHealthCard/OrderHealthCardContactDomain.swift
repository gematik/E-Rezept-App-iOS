...
/// Domain for handling health card contact information
@Reducer
public struct OrderHealthCardContactDomain {
    /// State for the contact information screen
    @ObservableState
    ...
    /// Actions that can be performed in the contact domain
