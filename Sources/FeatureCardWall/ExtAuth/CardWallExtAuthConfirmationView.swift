    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Button {
                ...
                Label(L10n.cdwBtnExtauthConfirmSend)
            }
            .buttonStyle(.primary(isEnabled: !store.loading))
            .accessibilityIdentifier(A11y.cardWall.extAuthConfirmation.cdwBtnExtauthConfirmSend)
            .padding(.vertical, 8)
        }
        .navigationBarItems(
            trailing: Button {
