...
extension JWE.EncryptionContext {
    ...
    public enum Algorithm {
        ...
        /// Derives a encryption context based on the selected algorithm and key exchange context
        public func encryptionContext() throws -> JWE.EncryptionContext {
            switch self {
        ...
        public enum KeyExchangeContext {
            ...
            func encryptionContext() throws -> JWE.EncryptionContext {
                switch self {
                case let .bpp256r1(staticPublicKey, keyPairGenerator: keyPairGenerator):
                    ...
                    return try JWE.EncryptionContext(
...
extension JWK {
    ...
    /// - Returns: A JWK
    public static func from(brainpoolP256r1 publicKey: BrainpoolP256r1.KeyExchange.PublicKey) throws -> Self {
        // Contains  04 || x || y
