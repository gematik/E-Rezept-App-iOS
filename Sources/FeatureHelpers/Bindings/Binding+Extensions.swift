...
extension Binding {
    ...
    public func transformInput(_ transformation: @escaping (Value) -> Value) -> Self {
        Binding<Value>(get: {
            self.wrappedValue
        }, set: { value in
...
extension Binding {
    ...
    public func onDidSet(_ onDidSet: @escaping (Value) -> Void) -> Self {
        Binding<Value>(get: {
            self.wrappedValue
        }, set: { value in
...
extension Binding where Value == String {
    /// Filter the characters of a String binding to a given character set.
    public func filterCharacters(to characterSet: CharacterSet = CharacterSet.decimalDigits) -> Self {
