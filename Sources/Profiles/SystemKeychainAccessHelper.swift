...
/// Protocol defining keychain access methods for storing, retrieving and deleting passwords.
public protocol KeychainAccessHelper {
...
extension KeychainAccessHelper {
    ...
    /// - Throws: `KeychainAccessHelperError`
    public func genericPassword(for account: String, encoding: String.Encoding = .utf8) throws -> String? {
    ...
    /// - Throws: `KeychainAccessHelperError`
    public func unsetGenericPassword(for account: String, encoding: String.Encoding = .utf8) throws -> Bool {
    ...
    /// - Throws: `KeychainAccessHelperError`
    public func setGenericPassword(_ password: String, for account: String,
    ...
    /// Retrieves generic password data for a given account
    /// - Parameters:
    ///   - account: The account identifier
    ///   - encoding: The string encoding to use
    /// - Returns: The password data if found
    public func genericPasswordData(for account: String, encoding: String.Encoding = .utf8) throws -> Data? {
    ...
    /// Removes a generic password from the keychain for a given account
    /// - Parameter account: The account data
    /// - Returns: True if the password was successfully removed
    public func unsetGenericPassword(for account: Data) throws -> Bool {
    ...
    /// Sets a generic password in the keychain for a given account string
    /// - Parameters:
    ///   - password: The password data to store
    ///   - account: The account identifier as string
    /// - Returns: True if the password was successfully stored
    public func setGenericPassword(_ password: Data, for account: String) throws -> Bool {
    ...
    /// Sets a generic password in the keychain for a given account data
    /// - Parameters:
    ///   - password: The password data to store
    ///   - account: The account identifier as data
    /// - Returns: True if the password was successfully stored
    public func setGenericPassword(_ password: Data, for account: Data) throws -> Bool {
        guard let service = defaultService.data(using: .utf8) else {
            throw KeychainAccessHelperError.illegalArgument
        }
    ...
    /// - Returns: true when successfully unset/removed.
    /// - Throws: `KeychainAccessHelperError`
    public func unsetGenericPassword(for account: String, ofService service: String,
                                     encoding: String.Encoding = .utf8) throws -> Bool {
        guard let accountData = account.data(using: encoding),
    ...
    /// - Returns: true when successfully set
    /// - Throws: `KeychainAccessHelperError`
    public func setGenericPassword(
        _ password: String,
        for account: String,
        service: String,
        encoding: String.Encoding = .utf8
...
/// Implementation of KeychainAccessHelper using iOS Keychain Services.
public struct SystemKeychainAccessHelper: KeychainAccessHelper {
    /// Initializes a new instance of SystemKeychainAccessHelper
    public init() {}
...
extension Logger {
    static let keychain = Logger(subsystem: "de.gematik.ti.erp.app", category: "keychain")
}
