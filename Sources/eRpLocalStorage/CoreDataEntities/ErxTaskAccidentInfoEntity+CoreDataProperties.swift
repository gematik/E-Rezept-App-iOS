...
extension ErxTaskAccidentInfoEntity {
    @nonobjc public class func fetchRequest() -> NSFetchRequest<ErxTaskAccidentInfoEntity> {
        NSFetchRequest<ErxTaskAccidentInfoEntity>(entityName: "ErxTaskAccidentInfoEntity")
    }
